define(['exports'], function (t) {
  ...
  class a {
    ...
    handleRequest ({ request: t, event: e }) {
      ...
      const { params: r, route: i } = this.findMatchingRoute({
        event: e,
        request: t,
        sameOrigin: n,
        url: s
  ...
  class R {
    ...
    async cacheMatch (t) {
      ...
      const i = await this.getCacheKey(e, 'read')
      const a = Object.assign(Object.assign({}, r), { cacheName: n })
  ...
  class v {
    ...
    handleAll (t) {
      ...
      const r = new R(this, { event: e, request: s, params: n })
      const i = this.q(r, s, e)
  ...
  let O = {
    get (t, e, s) {
      if (t instanceof IDBTransaction) {
        ...
        if (e === 'objectStoreNames') return t.objectStoreNames || C.get(t)
        if (e === 'store') {
  ...
  class F {
    ...
    async setTimestamp (t, e) {
      ...
      const n = (await this.getDb()).transaction(K, 'readwrite', {
        durability: 'relaxed'
      })
    ...
    async getTimestamp (t) {
      ...
      const s = await e.get(K, this.N(t))
  ...
  class H {
    ...
    async expireEntries () {
      ...
      const e = await this.M.expireEntries(t, this.k)
      const s = await self.caches.open(this.L)
  ...
  async function $ (t, e) {
    try {
      ...
      const o = i.slice(a.start, a.end)
      const c = o.size
      const h = new Response(o, {
        status: 206,
  ...
  class tt {
    ...
    addToCacheList (t) {
      ...
      for (const n of t) {
        ...
        const i = typeof n !== 'string' && n.revision ? 'reload' : 'default'
