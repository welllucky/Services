...
const textThemes: TextTheme[] = [
  ...
  },
  {
    ...
    title: "Flores Digitais no Seu Celular! 🌸",
    text: "Você entrou no jardim encantado, mas as flores digitais só desabrocham no celular! Acesse o Services e colha os conhecimentos perfumados.",
  },
  {
  ...
  },
  {
    ...
    title: "Doces Digitais, Só no Celular! 🍫",
    text: "Você está na fábrica de chocolate, mas as delícias digitais estão no celular! Acesse o Services e saboreie as respostas mais doces.",
  },
  {
  ...
  },
  {
    ...
    title: "Alquimia Digital, Só com o Celular! 🔮",
    text: "Você está no laboratório de alquimia, mas as poções mágicas só borbulham no celular! Acesse o Services e descubra os segredos da transmutação digital.",
  },
  {
    theme: "Vila dos Duendes",
    title: "Duendes Digitais, Só no Celular! 🧚‍♂️",
    text: "Você chegou à vila dos duendes, mas as travessuras mágicas só acontecem no celular! Explore o Services e entre no mundo encantado digital.",
  },
  {
    theme: "Café dos Viajantes",
    title: "Café Digital, Só com o Celular! ☕",
    text: "Você está no café dos viajantes, mas as histórias digitais só são servidas no celular! Acesse o Services e deguste as respostas aromáticas.",
  },
  {
    theme: "Oficina de Inventores",
    title: "Invenções Digitais, Só no Celular! 🛠️",
    text: "Você está na oficina de inventores, mas as criações geniais só surgem no celular! Explore o Services e descubra as inovações digitais.",
  },
  {
